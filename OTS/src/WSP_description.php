...
<head>
	...
	<meta charset="UTF-8">
	<title>Walnut stretch pant</title>
...
<body>
	...
	<h1 class = "text-despg">Walnut stretch pant<h1>
	<div><img src = "img/collection/imgWSPdes.jpg" class = "image1-despg"></div>
	<div><img src = "img/collection/img1WSPdes.jpg" class = "image2-despg"></div>
	<div><img src = "img/collection/img2WSPdes.jpg" class = "image3-despg"></div>
	<div><img src = "img/collection/img3WSPdes.jpg" class = "image4-despg"></div>
	<!--<div><img src = "img/collection/img4NBSdes.jpg" class = "image5-despg"></div>-->
	<p class= "description1-despg">Description</p>
	<p class = "description2-despg">Dayton Walnut stretch chinos provide you with a stunning, deep brown color that mixes well with various styles. Dress up these cotton lyocell mixed chinos with a solid color button-up shirt or maximize comfort and pair them with one of our Pima cotton single jersey t-shirts. The options for comfort are limitless with these chinos.</p>
