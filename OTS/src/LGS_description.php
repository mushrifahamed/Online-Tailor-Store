...
<head>
	...
	<meta charset="UTF-8">
	<title>Light gray dress shirt</title>
...
<body>
	...
	<h1 class = "text-despg">Light gray dress shirt<h1>
	<div><img src = "img/collection/imgLGSdes.jpg" class = "image1-despg"></div>
	<div><img src = "img/collection/img1LGSdes.jpg" class = "image2-despg"></div>
	<div><img src = "img/collection/img2LGSdes.jpg" class = "image3-despg"></div>
	...
	<p class = "description2-despg">Light grey Oxford shirt. The weave of the pinpoint Oxford is dense and opaque and has a soft texture. A comfortable everyday shirt with a button-down classic collar, for a relaxed look. Customize this shirt in your size.</p>
