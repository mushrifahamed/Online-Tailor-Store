...
<body>
	...
	<h1 class = "text-despg">Sand stretch pant<h1>
	<div><img src = "img/collection/imgSSPdes.jpg" class = "image1-despg"></div>
	<div><img src = "img/collection/img1SSPdes.jpg" class = "image2-despg"></div>
	<div><img src = "img/collection/img2SSPdes.jpg" class = "image3-despg"></div>
	<div><img src = "img/collection/img3SSPdes.jpg" class = "image4-despg"></div>
	<!--<div><img src = "img/collection/img4NBSdes.jpg" class = "image5-despg"></div>-->
	<p class= "description1-despg">Description</p>
	<p class = "description2-despg">Aiming for a dressy look? Dayton sand chino provides you with twill stretch to maximize movement and a blend of cotton and lyocell to ensure your comfort. Look your best and dress to impress in these sand-colored chinos. Whether you're going to the next big event or sitting at your desk knocking off tasks, the stretch build ensures you are always comfortable.</p>
