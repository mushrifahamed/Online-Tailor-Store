...
<body>
	...
	<h1 class = "text-despg">Blue stretch pant<h1>
	<div><img src = "img/collection/imgBSPdes.jpg" class = "image1-despg"></div>
	<div><img src = "img/collection/img1BSPdes.jpg" class = "image2-despg"></div>
	<div><img src = "img/collection/img2BSPdes.jpg" class = "image3-despg"></div>
	<div><img src = "img/collection/img3BSPdes.jpg" class = "image4-despg"></div>
	<!--<div><img src = "img/collection/img4NBSdes.jpg" class = "image5-despg"></div>-->
	<p class= "description1-despg">Description</p>
	<p class = "description2-despg">Dayton blue stretch chino gives you the best of both worlds with this cotton and lyocell fiber blend. Wear these chinos for a clean-cut look and stand out from the crowd while maintaining your comfort and class.</p>
