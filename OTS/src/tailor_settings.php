...
if ($user === null) {
    // Handle the case where the user does not exist in the 'staff' table
...
<head>
    ...
    <link rel="stylesheet" href="styles/tailor_settings.css">
</head>
<body>
    <div class="container">
        ...
        <div class="dashboard">
            <div class="profile">
                ...
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    ...
                    <input type="text" id="first_name" name="first_name" value="<?php echo isset($user['Fname']) ? $user['Fname'] : ''; ?>" required><br><br>

                    <label for="last_name">Full Name:</label>
                    <input type="text" id="last_name" name="last_name" value="<?php echo isset($user['Lname']) ? $user['Lname'] : ''; ?>" required><br><br>

                    <label for="phone_number">Phone Number:</label>
                    <input type="tel" id="phone_number" name="phone_number" value="<?php echo isset($user['PhoneNo']) ? $user['PhoneNo'] : ''; ?>" required><br><br>
