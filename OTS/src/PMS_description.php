...
<head>
	...
	<meta charset="UTF-8">
	<title>Peach melange linen shirt</title>
...
<body>
	...
	<h1 class = "text-despg">Peach melange linen shirt<h1>
	<div><img src = "img/collection/imgPMSdes.jpg" class = "image1-despg"></div>
	<div><img src = "img/collection/img1PMSdes.jpg" class = "image2-despg"></div>
	<div><img src = "img/collection/img2PMSdes.jpg" class = "image3-despg"></div>
	...
	<p class = "description2-despg">A modern, sophisticated linen shirt in peach, perfect for looking sharp at any warm weather event. Made from 100 % breathable and lightweight linen with a discreet melange weave.</p>
