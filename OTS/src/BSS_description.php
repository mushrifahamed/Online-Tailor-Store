...
<head>
	...
	<meta charset="UTF-8">
	<title>Blue two-piece striped suit</title>
...
<body>
	...
	<h1 class = "text-despg">Blue two-piece striped suit<h1>
	<div><img src = "img/collection/imgBSSdes.jpg" class = "image1-despg"></div>
	<div><img src = "img/collection/img1BSSdes.jpg" class = "image2-despg"></div>
	<div><img src = "img/collection/img2BSSdes.jpg" class = "image3-despg"></div>
	<div><img src = "img/collection/img3BSSdes.jpg" class = "image4-despg"></div>
	<div><img src = "img/collection/img4BSSdes.jpg" class = "image5-despg"></div>
	<p class= "description1-despg">Description</p>
	<p class = "description2-despg">Channel your inner James Bond and look dashing with this premium suit in 100% virgin wool from the Vitale Barberis Canonico mill in Italy. The wide blue pinstripe plain weave adds an extra level of sophistication and complexity to classic elegance. This piece is also perfect for a younger generation looking to combine style and quality seamlessly.</p>
