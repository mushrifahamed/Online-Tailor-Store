...
<head>
	...
	<meta charset="UTF-8">
	<title>Burgundy two-piece suit</title>
...
<body>
	...
	<h1 class = "text-despg">Burgundy two-piece suit</h1>
	<div><img src = "img/collection/imgMSdes.jpg" class = "image1-despg"></div>
	<div><img src = "img/collection/img1MSdes.jpg" class = "image2-despg"></div>
	<div><img src = "img/collection/img2MSdes.jpg" class = "image3-despg"></div>
	<div><img src = "img/collection/img3MSdes.jpg" class = "image4-despg"></div>
	<div><img src = "img/collection/img4MSdes.jpg" class = "image5-despg"></div>
	<p class= "description1-despg">Description</p>
	<p class = "description2-despg">Enjoy a tailored fit that flatters your look with our wool-stretch blend suit in a vibrant and eye-catching burgundy color. Our product is crafted from an impressive wool, polyester, and Elasthane combination. Not only is it timeless and stylish, but it's also woven using the highest-quality plain weave technique.</p>
