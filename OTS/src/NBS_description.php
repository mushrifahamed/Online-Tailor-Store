...
<head>
	...
	<meta charset="UTF-8">
	<title>Navy two-piece stretch suit</title>
...
<body>
	...
	<h1 class = "text-despg">Navy two-piece stretch suit<h1>
	<div><img src = "img/collection/imgNBSdes.jpg" class = "image1-despg"></div>
	<div><img src = "img/collection/img1NBSdes.jpg" class = "image2-despg"></div>
	<div><img src = "img/collection/img2NBSdes.jpg" class = "image3-despg"></div>
	...
	<p class = "description2-despg">Dress your best in this navy wool blend with stretch and a discreet melange effect that'll turn heads. Boast your confidence while adorning hand-crafted suit jackets and pants that are made to your measurements.</p>
