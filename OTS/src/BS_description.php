...
<head>
	...
	<meta charset="UTF-8">
	<title>Black two-piece suit</title>
...
<body>
	...
	<h1 class = "text-despg">Black two-piece suit<h1>
	<div><img src = "img/collection/imgBSdes.jpg" class = "image1-despg"></div>
	<div><img src = "img/collection/img1BSdes.jpg" class = "image2-despg"></div>
	<div><img src = "img/collection/img2BSdes.jpg" class = "image3-despg"></div>
	<div><img src = "img/collection/img3BSdes.jpg" class = "image4-despg"></div>
	<div><img src = "img/collection/img4BSdes.jpg" class = "image5-despg"></div>
	<p class= "description1-despg">Description</p>
	<p class = "description2-despg">Dress your best in thCrafted from pure 100% virgin wool in exquisite black plain weave from the renowned Vitale Barberis Canonico mill, this suit is a masterclass in quality and sophistication. The ultimate confidence booster, no occasion will be too formal to wear this stylish and timeless suit that inspires elegance wherever you go.</p>
	
	<p class = "price-despg">LKR 11500.00</p>
