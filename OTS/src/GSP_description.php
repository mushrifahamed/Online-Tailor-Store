...
<head>
	...
	<meta charset="UTF-8">
	<title>Green stretch pant</title>
...
<body>
	...
	<h1 class = "text-despg">Green stretch pant<h1>
	<div><img src = "img/collection/imgGSPdes.jpg" class = "image1-despg"></div>
	<div><img src = "img/collection/img1GSPdes.jpg" class = "image2-despg"></div>
	<div><img src = "img/collection/img2GSPdes.jpg" class = "image3-despg"></div>
	<div><img src = "img/collection/img3GSPdes.jpg" class = "image4-despg"></div>
	<!--<div><img src = "img/collection/img4NBSdes.jpg" class = "image5-despg"></div>-->
	<p class= "description1-despg">Description</p>
	<p class = "description2-despg">Dayton sage stretch chino is a stunning blend of gray and green that gives you a clean-cut appearance. These chinos offer a twill stretch that looks natural while maintaining professionalism. Show off your sleek look in comfort with these flexible, smoothly woven chinos.</p>
